@echo off
REM ================================================================
REM FLEET MAINTENANCE SYSTEM - INICIAR TODO CON UN CLICK
REM 
REM ESTE ES EL SCRIPT PARA USO NORMAL
REM 
REM Si es la PRIMERA VEZ o hay problemas, usa:
REM     ARREGLAR_DOCKER_Y_ABRIR.bat
REM 
REM Este script inicia: PostgreSQL + Redis + Backend + Frontend
REM ================================================================
...
echo Esperando a que Backend este listo (5 segundos)...
